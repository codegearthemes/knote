		...
		<ul class="social-icons clearfix <?php echo esc_attr( $classes ); ?>">
			...
			if( ! empty( $knote_facebook_link ) ): ?>
				<li class="text-center">
					...
					<a href="<?php echo esc_url( $knote_facebook_link ); ?>" title="<?php echo esc_attr( sprintf( __( '%1$s on %2$s', 'knote' ), get_bloginfo( 'name' ), __( 'Facebook', 'knote' ) )); ?>" target="_blank">
			...
			if( ! empty( $knote_twitter_link ) ): ?>
				<li class="text-center">
					<?php /* translators: %s: Network name */ ?>
					<a href="<?php echo esc_url( $knote_twitter_link ); ?>" title="<?php echo esc_attr( sprintf( __( '%1$s on %2$s', 'knote' ), get_bloginfo( 'name' ), __( 'Twitter', 'knote' )  )); ?>" target="_blank">
			...
			if( ! empty( $knote_linkedin_link ) ): ?>
				<li class="text-center">
					<?php /* translators: %s: Network name */ ?>
					<a href="<?php echo esc_url( $knote_linkedin_link ); ?>" title="<?php echo esc_attr( sprintf( __( '%1$s on %2$s', 'knote' ), get_bloginfo( 'name' ), __( 'LinkedIn', 'knote' )  )); ?>" target="_blank">
			...
			if( ! empty( $knote_instagram_link ) ): ?>
				<li class="text-center">
					<?php /* translators: %s: Network name */ ?>
					<a href="<?php echo esc_url( $knote_instagram_link ); ?>" title="<?php echo esc_attr( sprintf( __( '%1$s on %2$s', 'knote' ), get_bloginfo( 'name' ), __( 'Instagram', 'knote' )  )); ?>" target="_blank">
			...
			if( ! empty( $knote_youtube_link ) ): ?>
				<li class="text-center">
					<?php /* translators: %s: Network name */ ?>
					<a href="<?php echo esc_url( $knote_youtube_link ); ?>" title="<?php echo esc_attr( sprintf( __( '%1$s on %2$s', 'knote' ), get_bloginfo( 'name' ), __( 'Youtube', 'knote' )  )); ?>" target="_blank">
