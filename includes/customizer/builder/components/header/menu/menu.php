...
$styles = array();
$margin = Knote_Styles::dimensions_variables('knote_header_component_menu_margin', 'margin', 'menu');
$padding = Knote_Styles::dimensions_variables('knote_header_component_menu_padding', 'padding', 'menu');
