...
class Knote_Control_Typography_Preview extends WP_Customize_Control {

	/**
	 * The type of control being rendered
	 */
	public $type = 'knote-typography-preview';
	...
	public function render_content() {
		...
		$library = get_theme_mod( 'knote_typography_library', 'google' );
	...
	?>
		<div class="typography-preview" data-options="<?php echo esc_attr( json_encode( $this->options ) ); ?>" style="<?php echo esc_attr( $styles ); ?>">Aa</div>
	<?php
	}
}
