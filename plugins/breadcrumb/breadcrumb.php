...
class Breadcrumbs {
	...
	public function __construct( $element_args = [] ) {
		...
		$defaults = [
			...
			'show_terms'             => true,
			'home_label'             => esc_html__( 'Home', 'knote' ),
			'tag_archive_prefix'     => esc_html__( 'Tag:', 'knote' ),
			'search_prefix'          => esc_html__( 'Search:', 'knote' ),
			'error_prefix'           => esc_html__( '404 - Page not Found', 'knote' ),
		];
